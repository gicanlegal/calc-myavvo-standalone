...
export function CurrencySelector({ value, onChange }: CurrencySelectorProps) {
  ...
  return (
    <div ref={ref} className="relative w-full">
      ...
      {open && (
        <div className="absolute top-[calc(100%+4px)] left-0 right-0 bg-white dark:bg-slate-900 border border-[var(--border)] rounded-xl shadow-[var(--shadow)] z-50 max-h-64 overflow-y-auto">
          {CURRENCIES.map(c => (
            <div
              key={c.code}
